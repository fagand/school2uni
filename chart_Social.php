...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="main">
            <h2>Social Sciences and Business Law Programmes Statistics</h2>
            <div id="chartOne"></div>
            <script src="scripts/zingBarChart/social/Social.js"></script>
            <div id="chartTwo"></div>
            <script src="scripts/zingBarChart/social/Social_male.js"></script>
            <div id="chartThree"></div>
            <script src="scripts/zingBarChart/social/Social_female.js"></script>
        </div>
