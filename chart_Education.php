...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="main">
            <h2>Education Tertiary Programmes Statistics</h2>
            <div id="chartOne"></div>
            <script src="scripts/zingBarChart/education/Education.js"></script>
            <div id="chartTwo"></div>
            <script src="scripts/zingBarChart/education/EducationMale.js"></script>
            <div id="chartThree"></div>
            <script src="scripts/zingBarChart/education/EducationFemale.js"></script>
        </div>
