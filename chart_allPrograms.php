...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="main">
            <h2>Enrolement in University Education Statistics</h2>
            <div id="chartOne"></div>
            <script src="scripts/zingBarChart/allPrograms/AllProgramsBothSexes.js"></script>
            <div id="chartTwo"></div>
            <script src="scripts/zingBarChart/allPrograms/AllProgramsFemale.js"></script>
            <h3 align="center">⚠️ Unfortunately we were unable to find statistics on males only ⚠️</h3>
        </div>
