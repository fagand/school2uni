...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="main">
            <h2>Information and Comminication Technologies Tertiary Programmes Statistics</h2>
            <div id="chartOne"></div>
            <script src="scripts/zingBarChart/infocomms/InfoCommsBoth.js"></script>
            <div id="chartTwo"></div>
            <script src="scripts/zingBarChart/infocomms/InfoCommsMale.js"></script>
            <div id="chartThree"></div>
            <script src="scripts/zingBarChart/infocomms/InfoCommsFemale.js"></script>
        </div>
