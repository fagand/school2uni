...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="main">
            <h2>Engineering Tertiary Programmes Statistics</h2>
            <div id="chartOne"></div>
            <script src="scripts/zingBarChart/engineering/Engineering.js"></script>
            <div id="chartTwo"></div>
            <script src="scripts/zingBarChart/engineering/EngineeringMale.js"></script>
            <div id="chartThree"></div>
            <script src="scripts/zingBarChart/engineering/EngineeringFemale.js"></script>
        </div>
