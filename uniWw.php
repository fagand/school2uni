...
<head>
    ...
    <title>School 2 Uni | Worldwide Universities</title>
...
<!-- Section containing the flexible columns -->
    <section class="columns" onscroll="headerFunct()">
        ...
        <div class="column" id="unimain">
            <h2>Worldwide 🌍 Universities Content</h2>
            <p>
                Please see below list of universities from around the world.</p>
                <script src="scripts/worldUni_Table_WithSearch.js"></script>
        </div>
