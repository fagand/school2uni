...
<head>
    ...
    <title>School 2 Uni | United Kingdom Universities</title>
...
<!-- Section containing the flexible columns -->
    <section class="columns" onscroll="headerFunct()">
        ...
        <div class="column" id="unimain">
            <h2>United Kingdom 🇬🇧 Universities Content</h2>
            <p>Please see below list of universities in the UK.</p>
            <script src="scripts/ukUni_Table.js"></script>
        </div>
