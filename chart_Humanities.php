...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="main">
            <h2>Humanities and Arts Statistics</h2>
            <div id="chartOne"></div>
            <script src="scripts/zingBarChart/arts/Arts.js"></script>
            <div id="chartTwo"></div>
            <script src="scripts/zingBarChart/arts/ArtsMale.js"></script>
            <div id="chartThree"></div>
            <script src="scripts/zingBarChart/arts/ArtsFemale.js"></script>         
        </div>
