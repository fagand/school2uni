...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="unimain">
            <h2>Job Salary Content</h2>
            <input type="search" name="search" id="jobInput" placeholder="Enter  Career, e.g 'Computing or Law'" size="35"><br>
            <input type="search" name="age" id="inputAge" placeholder="Input Age" maxlength="2">
            <h4>Please see the below jobs classifications, if you click the classification more infomration will be provided.</h4>
            <h4 style="font-size: 0.7em !important; color:red">Please note: if you change the age, you have to re-do the search by pressing the return key in the job field box.</h4>
            <p>Information provided will be, description of the role along with tasks involved in the chose classifcation.</p>
            <script src="scripts/jobs_jobsWithSearch.js"></script>
        </div>
