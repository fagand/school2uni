...
<!-- Section containing the flexible columns -->
    <section class="columns">
        ...
        <div class="column" id="main">
            <h2>Agriculture, Forestry, Fiesheries and Veterinary Tertiary Programmes  Statistics</h2>
            <div id="chartOne"></div>
            <script src="scripts/zingBarChart/agriculture/Argiculture.js"></script>
            <div id="chartTwo"></div>
            <script src="scripts/zingBarChart/agriculture/ArgicultureMale.js"></script>
            <div id="chartThree"></div>
            <script src="scripts/zingBarChart/agriculture/ArgicultureFemale.js"></script>
        </div>
